...
from models import *
# if you are working with basic setup, you'll import data from here:
from datasets import *
# if you are working with the model with original frames train/val setup, you'll import data from here:
# from datasets_on_real_images import *
# if you are working with the model with skeletons train/val setup, you'll import data from here:
# from datasets_on_skeletons import *
...
root_local = './src/models/PyTorch-GAN/data/dance2energy'
dataloader = DataLoader(
    ImageDataset(
        # root_local,
        root='./src/models/PyTorch-GAN/data/dance2energy/',
        # if you are willing to train on skeleton images, use: <orig='gan_skeletons'>
        # orig='gan_skeletons',
        # if you are willing to train on orginal frames images, use: <orig='gan_frames'>
        orig='gan_frames',
...
val_dataloader = DataLoader(
    ImageDataset(
        # root_local,
        root='./src/models/PyTorch-GAN/data/dance2energy/',
        # if you are willing to validate on skeleton images, use: <orig='gan_skeletons'>
        # orig='gan_skeletons',
        # if you are willing to validate on orginal frames images, use: <orig='gan_frames'>
        orig='gan_frames',
        abstract='gan_abstractions',
        bbox='videos_bbox_json_data',
        input_size=input_shape[1],
